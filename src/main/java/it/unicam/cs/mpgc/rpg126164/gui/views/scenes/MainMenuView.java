...
public class MainMenuView {
     ...
     */
    public MainMenuView(MenuController menuController, WorldController worldController, MarketController marketController, LevelController levelController, CombatController combatController) {
    ...
    public Scene createScene(Stage stage) {
        ...
        infoButton.setOnAction(_ -> {
            InfoView infoPage = new InfoView(() -> stage.setScene(createScene(stage)));
    ...
    Button newGameActionButton(Stage stage) {
        ...
        button.setOnAction(_ -> {
            CreateCharacterView ccp = new CreateCharacterView(
                    menuController,
                    worldController,
                    marketController,
                    levelController,
    ...
    Button loadGameActionButton(Stage stage, Label deletedGame) {
        ...
        button.setOnAction(_ -> {
            try {
                ...
                WorldGameHubView gameHub = new WorldGameHubView(
                        menuController,
                        worldController,
                        marketController,
                        levelController,
